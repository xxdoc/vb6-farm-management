...
Begin VB.Form frmLogin 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtOldPassword 
         ...
         _ExtentY        =   767
      End
      Begin Threed.SSCheck chkEstimate 
         Height          =   375
         Left            =   1860
         TabIndex        =   2
         Top             =   1860
...
Private Sub chkEstimate_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      SendKeys ("{TAB}")
   End If
End Sub
...
Dim IsCanLogin As Boolean
   ...
   glbUser.SIMULATE_FLAG = Check2Flag(chkEstimate.Value)
...
Private Sub InitFormLayout()
   ...
   Call InitCheckBox(chkEstimate, "Simulate เหตุการณ์")
