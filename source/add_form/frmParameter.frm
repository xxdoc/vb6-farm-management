...
Dim OKClick As Boolean
   ...
   frmAddEditParameter.HeaderText = MapText("เพิ่มข้อมูลพารามิเตอร์")
...
Dim OKClick As Boolean
   ...
   frmAddEditParameter.HeaderText = MapText("แก้ไขข้อมูลพารามิเตอร์")
...
Dim OKClick As Boolean
   ...
   If Button = 2 Then
      ...
      lMenuChosen = oMenu.Popup("COPY พารามิเตอร์")
