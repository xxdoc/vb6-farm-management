...
Begin VB.Form frmAddEditPigBuyParamItem 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditPigBuyParamlItem.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmAddEditPigBuyParamItem"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblBuyDate, MapText("วันที่ซื้อ"))
   ...
   Call InitNormalLabel(lblADG, MapText("ราคา/ตัว"))
   Call InitNormalLabel(lblAvgWeight, MapText("น้ำหนัก/ตัว"))
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         uctlBuyDate.ShowDate = Ji.GetFieldValue("BUY_DATE")
         txtAmount.Text = Ji.GetFieldValue("BUY_AMOUNT")
         txtADG.Text = Ji.GetFieldValue("BUY_AVG_PRICE")
         txtAvgWeight.Text = Ji.GetFieldValue("BUY_AVG_WEIGHT")
         uctlParttypeLookup.MyCombo.ListIndex = IDToListIndex(uctlParttypeLookup.MyCombo, PigCodeToID(Ji.GetFieldValue("PIG_TYPE_NO")))
...
Dim RealIndex As Long
   ...
   Call Ji.SetFieldValue("BUY_AMOUNT", Val(txtAmount.Text))
   ...
   Call Ji.SetFieldValue("BUY_DATE", uctlBuyDate.ShowDate)
