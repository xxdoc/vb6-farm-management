...
Begin VB.Form frmAddEditPigTypeChangeParamlItem 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditPigTypeChangeParamlItem.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmAddEditPigTypeChangeParamlItem"
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         txtAmount.Text = Ji.GetFieldValue("TRANSFER_RATE")
...
Dim RealIndex As Long
   ...
   Call Ji.SetFieldValue("TRANSFER_RATE", txtAmount.Text)
   Call Ji.SetFieldValue("PIG_TYPE", uctlParttypeLookup.MyCombo.ItemData(Minus2Zero(uctlParttypeLookup.MyCombo.ListIndex)))
   Call Ji.SetFieldValue("PIG_TYPE_NAME", uctlParttypeLookup.MyCombo.Text)
   Call Ji.SetFieldValue("PIG_TYPE_NO", uctlParttypeLookup.MyTextBox.Text)
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call LoadProductType(uctlParttypeLookup.MyCombo, m_ProductTypes)
      Set uctlParttypeLookup.MyCollection = m_ProductTypes
