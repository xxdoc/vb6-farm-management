...
Private Sub InitFormLayout()
   ...
   Call InitCheckBox(ChkAutoMonth, "รีเซตทุกเดือน")
   Call InitCheckBox(ChkAutoYear, "รีเซตทุกปี")
...
'   Set D = New CMenuItem
'   D.MENU_TEXT = MapText("รหัสลูกค้า/ลูกหนี้")
'   D.KEY_ID = 70
'   D.PARENT_KEY = ""
'   D.ICON_INDEX1 = 1
'   D.ICON_INDEX2 = 2
...
'
'   Set D = New CMenuItem
'   D.MENU_TEXT = MapText("รหัสซัพพลายเออร์/เจ้าหนี้")
'   D.KEY_ID = 71
'   D.PARENT_KEY = ""
'   D.ICON_INDEX1 = 1
'   D.ICON_INDEX2 = 2
...
'   Set D = New CMenuItem
'   D.MENU_TEXT = MapText("รหัสพนักงาน")
'   D.KEY_ID = 72
'   D.PARENT_KEY = ""
'   D.ICON_INDEX1 = 1
'   D.ICON_INDEX2 = 2
...
'   Set D = Nothing
   ...
   Set D = New CMenuItem
   D.MENU_TEXT = MapText("ใบนำฝากธนาคาร")
   D.KEY_ID = 81
   D.PARENT_KEY = ""
   D.ICON_INDEX1 = 1
   D.ICON_INDEX2 = 2
