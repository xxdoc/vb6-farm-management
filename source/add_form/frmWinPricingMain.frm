...
Dim NewNodeID As String
   ...
   Set Node = trvMain.Nodes.Add(, tvwFirst, ROOT_TREE, MapText("ระบบบริหารงาน ฟาร์มสุกร"), 1)
   Node.Expanded = True
   Node.Selected = True
   ...
   Set Node = trvMain.Nodes.Add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-4", MapText("ระบบบริหารสุกร"), 9, 9)
   Node.Expanded = False
   
   Set Node = trvMain.Nodes.Add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-7", MapText("ระบบการตั้งราคาสินค้าขาย"), 10, 10)
   Node.Expanded = False
...
Dim Node As Node
   ...
   Set Node = trvMain.Nodes.Add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-6", MapText("ระบบ Simulate"), 10, 10)
   Node.Expanded = False
End Sub
...
'   cmdBuy.Picture = LoadPicture(glbParameterObj.MainButton)
   ...
   Me.Caption = MapText("ระบบบริหารงาน ฟาร์มสุกร")
   ...
   Call InitMainButton(cmdMaster3, MapText("ข้อมูลหลักระบบบริหารสุกร"))
   Call InitMainButton(cmdMaster4, MapText("ข้อมูลหลักระบบบริหารบัญชี"))
   Call InitMainButton(cmdMaster5, MapText("ข้อมูลหลักระบบการตั้งราคา"))

   Call InitMainButton(cmdMainEnterprise, MapText("ข้อมูลองค์กร (ฟาร์ม)"))
   ...
   Call InitMainButton(cmdRawMatterial, MapText("ข้อมูลวัตถุดิบ"))
   ...
   Call InitMainButton(cmdPigImport, MapText("ข้อมูลการนำเข้าสุกร"))
...
'   Call InitMainButton(cmdBuy, MapText("ระบบงานซื้อ (รายจ่าย)"))
   ...
   Call InitMainButton(cmdGeneric, MapText("ระบบซื้อเข้า"))
   Call InitMainButton(cmdCapital, MapText("ระบบงานต้นทุน"))
   Call InitMainButton(cmdCash, MapText("เงินสดหน้าฟาร์ม"))
   Call InitMainButton(cmdLedgerReport, MapText("รายงานระบบบัญชี"))
   
   Call InitMainButton(cmdParameter, MapText("ข้อมูลพารามิเตอร์"))
   Call InitMainButton(cmdBatch, MapText("ข้อมูลแบต Simulate"))
   Call InitMainButton(cmdSimulateReport, MapText("รายงานระบบ Simulate"))
   
   Call InitMainButton(cmdSetCost, MapText("ข้อมูลการตั้งราคาขาย"))
...
Dim oMenu As cPopupMenu
   ...
   lMenuChosen = oMenu.Popup("ใบรับของ")
...
Dim oMenu As cPopupMenu
   ...
   Set oMenu = New cPopupMenu
   lMenuChosen = oMenu.Popup("ปันต้นทุน ค.ช.จ.", "-", "ใบเพิ่มต้นทุน", "-", "ใบลดต้นทุน", "-", "ปันต้นทุนจากรายได้อื่นๆ")
   If lMenuChosen = 0 Then
      Exit Sub
   End If
   
   If lMenuChosen = 1 Then
      If Not VerifyAccessRight("LEDGER_COST_5", "ปันต้นทุน ค.ช.จ.") Then                                                                                     '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
      ...
      Set frmBillingDoc2 = Nothing
   ElseIf lMenuChosen = 3 Then
      If Not VerifyAccessRight("LEDGER_COST_6", "ใบเพิ่มต้นทุน") Then                                                                                     '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
   ...
   ElseIf lMenuChosen = 5 Then
      If Not VerifyAccessRight("LEDGER_COST_7", "ใบลดต้นทุน") Then                                                                                     '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
   ...
   ElseIf lMenuChosen = 7 Then
      If Not VerifyAccessRight("LEDGER_COST_REVENUE", "ปันต้นทุนจากรายได้อื่นๆ") Then                                                                                     '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
...
Dim oMenu As cPopupMenu
   ...
   Set oMenu = New cPopupMenu
   lMenuChosen = oMenu.Popup("เงินฝากธนาคาร", "-", "ใบยืนยันการ clearing เช็ค")
   If lMenuChosen = 0 Then
      Exit Sub
   End If
...
Dim oMenu As cPopupMenu
   ...
   Set oMenu = New cPopupMenu
   lMenuChosen = oMenu.Popup("พารามิเตอร์การเกิด", "-", "พารามิเตอร์การใช้อาหาร", "-", "พารามิเตอร์การโอน (สูญเสีย)", "-", "พารามิเตอร์การขาย", "-", "พารามิเตอร์ราคาอาหาร/ยา", "-", "ยอดยกมาสุกร", "-", "พารามิเตอร์ขายอื่น ๆ", "-", "พารามิเตอร์ % การขาย", "-", "พารามิเตอร์การเปลี่ยนประเภทสุกร", "-", "พารามิเตอร์การซื้อสุกร", "-", "พารามิเตอร์การปันค่าใช้จ่าย", "-", "พารามิเตอร์การคุมยอดสุกร", "-", "พารามิเตอร์ค่าใช้จ่ายขาย/บริหาร", "-", "ยกมาหมู GL", "-", "G กลับสัตว์")
   Set oMenu = Nothing
   If lMenuChosen <= 0 Then
      Exit Sub
   End If
   ...
   If lMenuChosen = 1 Then
      ...
      frmParameter.HeaderText = "พารามิเตอร์การเกิด"
   ElseIf lMenuChosen = 3 Then
      frmParameter.ParamArea = 2
      frmParameter.HeaderText = "พารามิเตอร์การใช้อาหาร"
   ElseIf lMenuChosen = 5 Then
      frmParameter.ParamArea = 3
      frmParameter.HeaderText = "พารามิเตอร์การโอน (สูญเสีย)"
   ElseIf lMenuChosen = 7 Then
      frmParameter.ParamArea = 4
      frmParameter.HeaderText = "พารามิเตอร์การขาย"
'   ElseIf lMenuChosen = 9 Then
'      frmParameter.ParamArea = 5
'      frmParameter.HeaderText = "พารามิเตอร์การเพิ่มน้ำหนัก"
   ElseIf lMenuChosen = 9 Then
      frmParameter.ParamArea = 6
      frmParameter.HeaderText = "พารามิเตอร์ราคาอาหาร/ยา"
   ElseIf lMenuChosen = 11 Then
      frmParameter.ParamArea = 7
      frmParameter.HeaderText = "ยอดยกมาสุกร"
   ElseIf lMenuChosen = 13 Then
      frmParameter.ParamArea = 9
      frmParameter.HeaderText = "พารามิเตอร์ขายอื่น ๆ"
   ElseIf lMenuChosen = 15 Then
      frmParameter.ParamArea = 10
      frmParameter.HeaderText = "พารามิเตอร์ % การขาย"
   ElseIf lMenuChosen = 17 Then
      frmParameter.ParamArea = 11
      frmParameter.HeaderText = "พารามิเตอร์การเปลี่ยนประเภทสุกร"
   ElseIf lMenuChosen = 19 Then
      frmParameter.ParamArea = 12
      frmParameter.HeaderText = "พารามิเตอร์การซื้อสุกร"
   ElseIf lMenuChosen = 21 Then
      frmParameter.ParamArea = 13
      frmParameter.HeaderText = "พารามิเตอร์การปันค่าใช้จ่าย"
   ElseIf lMenuChosen = 23 Then
      frmParameter.ParamArea = 14
      frmParameter.HeaderText = "พารามิเตอร์การคุมยอดสุกร"
   ElseIf lMenuChosen = 25 Then
      frmParameter.ParamArea = 15
      frmParameter.HeaderText = "พารามิเตอร์ค่าใช้จ่ายขายบริหาร"
   ElseIf lMenuChosen = 27 Then
      frmParameter.ParamArea = 16
      frmParameter.HeaderText = "พารามิเตอร์ยกมาหมู GL"
   ElseIf lMenuChosen = 29 Then
      frmParameter.ParamArea = 17
      frmParameter.HeaderText = "พารามิเตอร์G กลับสัตว์"
   End If
...
Dim p As CPatch
   ...
   ElseIf lMenuChosen = 11 Then
      glbErrorLog.LocalErrorMsg = "โปรแกรมจะทำการลบข้อมูลการเคลื่อนไหวต้นทุน และต้นทุนยกมา ให้ดำเนินการต่อหรือไม่"
...
Dim oMenu As cPopupMenu
   ...
   Set oMenu = New cPopupMenu
   lMenuChosen = oMenu.Popup("โอนย้ายสุกร", "-", "โอนสุกรเข้าเรือนขาย", "-", "โอนสุกรเป็นพ่อแม่ (เปลี่ยนประเภทสุกร)", "-", "โอนเปลี่ยนสถานะสุกรในเรือนขาย", "-", "โอน G เป็น L")
   If lMenuChosen = 0 Then
      Exit Sub
   End If
...
Dim oMenu As cPopupMenu
   ...
   Set oMenu = New cPopupMenu
   lMenuChosen = oMenu.Popup("ใบส่งของ", "-", "ใบรับเงินชั่วคราว", "-", "ใบเสร็จรับเงิน", "-", "ใบเพิ่มหนี้", "-", "ใบลดหนี้")
   If lMenuChosen = 0 Then
      Exit Sub
   End If

   If lMenuChosen = 1 Then
      If Not VerifyAccessRight("LEDGER_SELL_1", "ใบส่งของ") Then                                                                                     '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
   ...
   ElseIf lMenuChosen = 5 Then
      If Not VerifyAccessRight("LEDGER_SELL_2", "ใบเสร็จรับเงิน") Then                                                                               '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
      frmBillingDoc1.DocumentType = 2
   ElseIf lMenuChosen = 7 Then
      If Not VerifyAccessRight("LEDGER_SELL_3", "ใบเพิ่มหนี้") Then                                                                               '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
      frmBillingDoc1.DocumentType = 3
   ElseIf lMenuChosen = 9 Then
      If Not VerifyAccessRight("LEDGER_SELL_4", "ใบลดหนี้") Then                                                                                          '''''''''
         Call EnableForm(Me, True)
         Exit Sub
      End If
