...
Dim OKClick As Boolean
   ...
   frmAddEditPigDoc4.HeaderText = MapText("เพิ่มข้อมูลการนำเข้าสุกร")
...
Dim BatchID As Long
   ...
   frmAddEditPigDoc4.HeaderText = MapText("แก้ไขข้อมูลการนำเข้าสุกร")
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_InventoryDoc.DOCUMENT_TYPE = 11 'ใบนำเข้าสุกร
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblDocumentNo, MapText("เลขที่ใบนำเข้า"))
