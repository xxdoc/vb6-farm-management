...
Dim ID As Long
   ...
   If Not VerifyAccessRight("PIG_ADJUST_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
...
Dim BatchID As Long
   ...
   frmAddEditPigDoc3.BATCH_ID = BatchID
   frmAddEditPigDoc3.ID = ID
   frmAddEditPigDoc3.HeaderText = MapText("แก้ไขข้อมูลการปรับยอดสุกร")
...
Dim OKClick As Boolean
   ...
   frmProcssCommit.DocumentType = 9
