...
Begin VB.Form frmPigDoc1 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmPigDoc1.frx":3A14
         Column(2)       =   "frmPigDoc1.frx":3ADC
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmPigDoc1.frx":3B80
         FormatStyle(2)  =   "frmPigDoc1.frx":3CDC
         FormatStyle(3)  =   "frmPigDoc1.frx":3D8C
         FormatStyle(4)  =   "frmPigDoc1.frx":3E40
         FormatStyle(5)  =   "frmPigDoc1.frx":3F18
         ImageCount      =   0
         PrinterProperties=   "frmPigDoc1.frx":3FD0
      End
...
Dim ID As Long
   ...
   If Not VerifyAccessRight("PIG_BIRTH_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
...
Dim BatchID As Long
   ...
   frmAddEditPigDoc1.BATCH_ID = BatchID
   frmAddEditPigDoc1.ID = ID
   frmAddEditPigDoc1.HeaderText = MapText("แก้ไขข้อมูลสุกรคลอด")
...
Dim OKClick As Boolean
   ...
   frmProcssCommit.DocumentType = 5
