...
Begin VB.Form frmAddEditUserGroup 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditUserGroup.frx":307C
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditUserGroup.frx":3396
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditUserGroup.frx":36B0
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditUserGroup.frx":39CA
         ButtonStyle     =   3
      End
   End
End
