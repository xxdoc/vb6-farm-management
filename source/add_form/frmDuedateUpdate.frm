...
Begin VB.Form frmDueDateUpdate 
   BackColor       =   &H80000000&
   ...
   ClientTop       =   330
   ClientWidth     =   10410
   Icon            =   "frmDuedateUpdate.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdStart 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmDuedateUpdate.frx":27A2
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmDuedateUpdate.frx":2ABC
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmDueDateUpdate"
...
'-----------------------------------------------------------------------------------------------------
   ...
   Bd.COMMIT_FLAG = ""
   Call Bd.QueryData(1, Rs1, Count1)
   ...
   While Not Rs1.EOF
      ...
      Call TempBD.PopulateFromRS(1, Rs1)
      TempBD.DUE_DATE = DateAdd("D", TempBD.CREDIT, TempBD.DOCUMENT_DATE)
      Call TempBD.PatchDueDate
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = "ปรับแก้ข้อมูกำหนดชำระเงิน"
