...
Private m_PigNos As Collection
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblToLocation, MapText("เข้าเรือนขาย"))
...
Dim Pi As CPartItem
   ...
   If uctlPigNoLookup.MyCombo.ListIndex > 0 Then
      Pi.PART_ITEM_ID = uctlPigNoLookup.MyCombo.ItemData(Minus2Zero(uctlPigNoLookup.MyCombo.ListIndex))
      Pi.PARENT_ID = uctlPartLookup.MyCombo.ItemData(Minus2Zero(uctlPartLookup.MyCombo.ListIndex))
      Pi.PART_NO = uctlPigNoLookup.MyTextBox.Text
   ...
   EnpAddress.ExportItem.PART_ITEM_ID = Pi.PART_ITEM_ID  'uctlPartLookup.MyCombo.ItemData(Minus2Zero(uctlPartLookup.MyCombo.ListIndex))
   ...
   EnpAddress.ExportItem.PART_NO = Pi.PART_NO   'uctlPartLookup.MyTextBox.Text
   EnpAddress.ExportItem.PART_DESC = Pi.PART_DESC  'uctlPartLookup.MyCombo.Text
   ...
   'EnpAddress.ExportItem.PIG_AGE
   
   EnpAddress.ImportItem.PART_ITEM_ID = Pi.PART_ITEM_ID 'uctlPartLookup.MyCombo.ItemData(Minus2Zero(uctlPartLookup.MyCombo.ListIndex))
   ...
   EnpAddress.ImportItem.PART_NO = Pi.PART_NO  'uctlPartLookup.MyTextBox.Text
   EnpAddress.ImportItem.PART_DESC = Pi.PART_DESC   'uctlPartLookup.MyCombo.Text
   ...
   EnpAddress.ImportItem.PIG_STATUS = uctlPigStatusLookup.MyCombo.ItemData(Minus2Zero(uctlPigStatusLookup.MyCombo.ListIndex))
