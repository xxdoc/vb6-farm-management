...
Begin VB.Form frmArRemove 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdStart 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmArRemove.frx":27A2
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmArRemove.frx":2ABC
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmArRemove"
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = "เคลื่อนย้ายข้อมูลลูกหนี้"
   ...
   Call InitNormalLabel(lblCustomer, "รหัสลูกค้า")
