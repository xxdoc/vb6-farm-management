...
Begin VB.Form frmInventoryDoc4 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryDoc4.frx":3B9E
         ButtonStyle     =   3
      End
   End
End
...
Dim BatchID As Boolean
   ...
   frmAddEditInventoryDoc4.BATCH_ID = BatchID
...
Dim OKClick As Boolean
   ...
   frmProcssCommit.DocumentType = 4
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_InventoryDoc.DOCUMENT_TYPE = 4 'ใบปรับยอด
