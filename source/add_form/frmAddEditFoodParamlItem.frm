...
Begin VB.Form frmAddEditFoodParamItem 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditFoodParamlItem.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3810
   ...
   End
End
Attribute VB_Name = "frmAddEditFoodParamItem"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblAmount, MapText("INTAKE"))
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         Dim Ji As CUsedPrmItem

         Set Ji = TempCollection.Item(ID)
         
         txtAmount.Text = Ji.GetFieldValue("USED_RATE")
         txtADG.Text = Ji.GetFieldValue("ADG_RATE")
         ...
         cboType.ListIndex = IDToListIndex(cboType, Ji.GetFieldValue("INTAKE_TYPE"))
      End If
   End If
...
Dim RealIndex As Long
   ...
   Call Ji.SetFieldValue("USED_RATE", Val(txtAmount.Text))
   Call Ji.SetFieldValue("ADG_RATE", Val(txtADG.Text))
   ...
   Call Ji.SetFieldValue("INTAKE_TYPE", cboType.ItemData(Minus2Zero(cboType.ListIndex)))
