...
'   End If
   ...
   frmAddEditPayment.HeaderText = MapText("เพิ่มข้อมูลใบนำฝากเงิน")
...
'   End If
   ...
   frmAddEditPayment.HeaderText = MapText("เแก้ไขข้อมูลใบนำฝากเงิน")
...
Private Sub InitFormLayout()
   ...
   If Direction = "O" Then
      Me.Caption = MapText("เงินสดฝากธนาคาร")
...
Dim RealIndex As Long
   ...
   Values(2) = m_TempPayment.ACCOUNT_NAME
