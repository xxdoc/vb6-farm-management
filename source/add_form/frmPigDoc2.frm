...
Dim OKClick As Boolean
   ...
   ElseIf DocumentType = 12 Then
      frmAddEditPigDoc2.HeaderText = MapText("เพิ่มข้อมูลการโอนเปลี่ยนสถานะสุกร")
   ElseIf DocumentType = 888 Then
      frmAddEditPigDoc2.HeaderText = MapText("เพิ่มข้อมูลการโอนเปลี่ยน G เป็น L ")
   End If
...
Dim ID As Long
   ...
   If Not VerifyAccessRight("PIG_TRANSFER_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
...
Dim BatchID As Long
   ...
   ElseIf DocumentType = 12 Then
      frmAddEditPigDoc2.HeaderText = MapText("แก้ไขข้อมูลการโอนเปลี่ยนสถานะสุกร")
   ElseIf DocumentType = 888 Then
      frmAddEditPigDoc2.HeaderText = MapText("แก้ไขข้อมูลการโอนเปลี่ยน G เป็น L")
   End If
   frmAddEditPigDoc2.DocumentType = DocumentType
   frmAddEditPigDoc2.BATCH_ID = BatchID
...
Private Sub InitFormLayout()
   ...
   ElseIf DocumentType = 12 Then
      Me.Caption = MapText("โอนเปลี่ยนสถานะสุกร")
   ElseIf DocumentType = 888 Then
      Me.Caption = MapText("โอนเปลี่ยน G เป็น L")
   End If
