...
Begin VB.Form frmAddEditInventoryDoc2 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtDeliveryFee 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextLookup uctlSuretyLookup 
         Height          =   435
         Left            =   1860
         TabIndex        =   3
         Top             =   1980
...
Private m_Surety As Collection
...
Dim ItemCount As Long
   ...
   If ItemCount > 0 Then
      ...
      uctlSuretyLookup.MyCombo.ListIndex = IDToListIndex(uctlSuretyLookup.MyCombo, m_InventoryDoc.SURETY_ID)    '
...
Dim IsOK As Boolean
   ...
   If Not VerifyCombo(lblEmployeeNo, uctlEmployeeLookup.MyCombo, True) Then
      Exit Function
   End If
  If Not VerifyCombo(lblSuretyNo, uctlSuretyLookup.MyCombo, True) Then
      Exit Function
   End If
   ...
   m_InventoryDoc.SURETY_ID = uctlSuretyLookup.MyCombo.ItemData(Minus2Zero(uctlSuretyLookup.MyCombo.ListIndex))
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      frmAddEditExportItem.DefaultLocationID = glbDaily.GetPreviousLocationID(m_InventoryDoc.ImportExports, 1)
      frmAddEditExportItem.DefaultHouseID = glbDaily.GetPreviousLocationID(m_InventoryDoc.ImportExports, 2)
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call LoadEmployee(uctlSuretyLookup.MyCombo, m_Surety)
      Set uctlSuretyLookup.MyCollection = m_Surety
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblSuretyNo, MapText("ผู้เบิก"))
...
Dim RealIndex As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      Values(1) = CR.EXPORT_ITEM_ID
      Values(2) = RealIndex
      Values(3) = CR.PART_NO
      Values(4) = CR.PART_DESC
      Values(5) = CR.PIG_NO
      Values(6) = FormatNumber(CR.EXPORT_AMOUNT)
      Values(7) = FormatNumber(CR.EXPORT_AVG_PRICE)
      Values(8) = FormatNumber(CR.EXPORT_AMOUNT * CR.EXPORT_AVG_PRICE)
      Values(9) = CR.LOCATION_NAME
      Values(10) = CR.HOUSE_NAME
      Values(11) = CR.PART_PIG_TYPE
   ElseIf TabStrip1.SelectedItem.Index = 2 Then
   ElseIf TabStrip1.SelectedItem.Index = 3 Then
   ElseIf TabStrip1.SelectedItem.Index = 4 Then
   ElseIf TabStrip1.SelectedItem.Index = 5 Then
...
Private Sub uctlSuretyLookup_Change()
   m_HasModify = True
End Sub
