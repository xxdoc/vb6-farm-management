...
Dim PaymentID As Long
   ...
   If Not VerifyAccessRight("LEDGER_CASH_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
...
Dim RealIndex As Long
   ...
   If DocumentType = CASH_PITTYCASH Then
      ...
      Values(5) = m_TempBillingDoc.GetFieldValue("DOCUMENT_DATE")
   Else
      ...
      Values(7) = m_TempBillingDoc.GetFieldValue("DOCUMENT_DATE")
   End If
