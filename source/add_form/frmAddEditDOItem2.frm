...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblPigType, MapText("ประเภทวัตถุดิบ"))
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         txtAvgPrice.Text = MyDiff(Di.TOTAL_PRICE, Di.ITEM_AMOUNT)
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call LoadLocation(uctlToLocationLookup.MyCombo, m_Locations, 2, "")
...
Private Sub CalculateAvgPrice()
   txtAvgPrice.Text = MyDiff(Val(txtTotalPrice.Text), Val(txtQuantity.Text))
End Sub

Private Sub txtQuantity_Change()
   m_HasModify = True
   Call CalculateAvgPrice
End Sub
