...
Begin VB.Form frmInventoryDoc3 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryDoc3.frx":3B9E
         ButtonStyle     =   3
      End
   End
End
...
Dim BatchID As Long
   ...
   frmAddEditInventoryDoc3.BATCH_ID = BatchID
...
Dim OKClick As Boolean
   ...
   frmProcssCommit.DocumentType = 3
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_InventoryDoc.PART_NO_IMPORT = txtPartNo.Text
      m_InventoryDoc.DOCUMENT_DATE = uctlDocumentDate.ShowDate
      m_InventoryDoc.DOCUMENT_TYPE = 3 'ใบโอน
