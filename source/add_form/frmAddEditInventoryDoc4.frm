...
Begin VB.Form frmAddEditInventoryDoc4 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryDoc4.frx":3884
         ButtonStyle     =   3
      End
...
Dim IsOK As Boolean
   ...
   m_InventoryDoc.DOCUMENT_TYPE = 4
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      frmAddEditAdjustItem1.DefaultLocationID = glbDaily.GetPreviousLocationID(m_InventoryDoc.ImportItems, 1)
      frmAddEditAdjustItem1.COMMIT_FLAG = m_InventoryDoc.COMMIT_FLAG
      frmAddEditAdjustItem1.TxSeq = GetNextID
      Set frmAddEditAdjustItem1.TempCollection = m_InventoryDoc.ImportItems
      frmAddEditAdjustItem1.ParentShowMode = ShowMode
      frmAddEditAdjustItem1.ShowMode = SHOW_ADD
      frmAddEditAdjustItem1.HeaderText = MapText("เพิ่มรายการปรับยอด (เพิ่ม)")
      Load frmAddEditAdjustItem1
      frmAddEditAdjustItem1.Show 1

      OKClick = frmAddEditAdjustItem1.OKClick

      Unload frmAddEditAdjustItem1
      Set frmAddEditAdjustItem1 = Nothing
   ...
   ElseIf TabStrip1.SelectedItem.Index = 2 Then
      frmAddEditAdjustItem2.DefaultLocationID = glbDaily.GetPreviousLocationID(m_InventoryDoc.ExportItems, 1)
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      frmAddEditAdjustItem1.ID = ID
      frmAddEditAdjustItem1.COMMIT_FLAG = m_InventoryDoc.COMMIT_FLAG
      Set frmAddEditAdjustItem1.TempCollection = m_InventoryDoc.ImportItems
      frmAddEditAdjustItem1.HeaderText = MapText("แก้ไขรายการปรับยอด (เพิ่ม)")
      frmAddEditAdjustItem1.ParentShowMode = ShowMode
      frmAddEditAdjustItem1.ShowMode = SHOW_EDIT
      Load frmAddEditAdjustItem1
      frmAddEditAdjustItem1.Show 1
...
Private Sub InitFormLayout()
   ...
   TabStrip1.Tabs.Add().Caption = MapText("รายการตรวจนับ")
...
Dim RealIndex As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      Values(5) = FormatNumber(CR.ACTUAL_AMOUNT)
      Values(6) = FormatNumber(MyDiffEx(CR.ACTUAL_PRICE, CR.ACTUAL_AMOUNT))
      Values(7) = FormatNumber(CR.ACTUAL_PRICE)
   ...
   ElseIf TabStrip1.SelectedItem.Index = 2 Then
      ...
      Values(6) = FormatNumber(EI.EXPORT_AVG_PRICE)
      Values(7) = FormatNumber(EI.EXPORT_AMOUNT * EI.EXPORT_AVG_PRICE)
