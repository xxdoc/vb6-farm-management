...
Begin VB.Form frmAddEditGLAgeAmount 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditGLAgeAmount.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2685
   ...
   End
End
Attribute VB_Name = "frmAddEditGLAgeAmount"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblAge, MapText("อายุ"))
