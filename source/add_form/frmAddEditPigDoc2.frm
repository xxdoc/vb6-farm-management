...
Begin VB.Form frmAddEditPigDoc2 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPigDoc2.frx":3884
         ButtonStyle     =   3
      End
...
Dim IsOK As Boolean
   ...
   If ShowMode = SHOW_ADD Then
      If Not VerifyAccessRight("PIG_TRANSFER_ADD") Then
         Call EnableForm(Me, True)
         Exit Function
      End If
   ElseIf ShowMode = SHOW_EDIT Then
      If Not VerifyAccessRight("PIG_TRANSFER_EDIT") Then
         Call EnableForm(Me, True)
         Exit Function
      End If
   End If
   ...
   If (m_InventoryDoc.COMMIT_FLAG = "Y") Then
      If m_InventoryDoc.OLD_COMMIT_FLAG <> "Y" Then
         ...
         If DocumentType = 12 Then
            'มีการตัดสต็อคโดยดูสถานะสุกรด้วย
            If Not glbDaily.VerifyStockBalanceEx(m_InventoryDoc.ImportExports, glbErrorLog) Then
               m_InventoryDoc.COMMIT_FLAG = "N"
               Call EnableForm(Me, True)
               Exit Function
            End If
...
Dim II As CImportItem
   ...
   For Each Ti In m_InventoryDoc.TransferItems
      ...
      EI.PIG_AGE = GetAge(EI.PART_NO, m_InventoryDoc.DOCUMENT_DATE)
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      ElseIf DocumentType = 7 Then
         ...
         If OKClick Then
            ...
            GridEX1.Rebind
         End If
      ElseIf DocumentType = 8 Or DocumentType = 888 Then
      ...
      ElseIf DocumentType = 12 Then
         frmAddEditPigChangeStatusItem.COMMIT_FLAG = m_InventoryDoc.COMMIT_FLAG
         Set frmAddEditPigChangeStatusItem.TempCollection = m_InventoryDoc.TransferItems
         frmAddEditPigChangeStatusItem.ParentShowMode = ShowMode
         frmAddEditPigChangeStatusItem.ShowMode = SHOW_ADD
         frmAddEditPigChangeStatusItem.HeaderText = MapText("เพิ่มรายการโอนย้ายสถานะสุกร")
         Load frmAddEditPigChangeStatusItem
         frmAddEditPigChangeStatusItem.Show 1
   
         OKClick = frmAddEditPigChangeStatusItem.OKClick
   
         Unload frmAddEditPigChangeStatusItem
         Set frmAddEditPigChangeStatusItem = Nothing
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      ElseIf DocumentType = 8 Or DocumentType = 888 Then
         ...
         End If
      ElseIf DocumentType = 12 Then
         frmAddEditPigChangeStatusItem.ID = ID
         frmAddEditPigChangeStatusItem.COMMIT_FLAG = m_InventoryDoc.COMMIT_FLAG
         Set frmAddEditPigChangeStatusItem.TempCollection = m_InventoryDoc.TransferItems
         frmAddEditPigChangeStatusItem.HeaderText = MapText("แก้ไขรายการโอนย้ายสุกรเป็นพ่อแม่")
         frmAddEditPigChangeStatusItem.ParentShowMode = ShowMode
         frmAddEditPigChangeStatusItem.ShowMode = SHOW_EDIT
         Load frmAddEditPigChangeStatusItem
         frmAddEditPigChangeStatusItem.Show 1
...
Dim RealIndex As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      Values(2) = RealIndex
      Values(3) = CR.ImportItem.PART_NO
      Values(4) = CR.ImportItem.PART_DESC
