...
Begin VB.Form frmAddEditPigDoc4 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddEditPigDoc4.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditPigDoc4.frx":27A2
         Column(2)       =   "frmAddEditPigDoc4.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditPigDoc4.frx":290E
         FormatStyle(2)  =   "frmAddEditPigDoc4.frx":2A6A
         FormatStyle(3)  =   "frmAddEditPigDoc4.frx":2B1A
         FormatStyle(4)  =   "frmAddEditPigDoc4.frx":2BCE
         FormatStyle(5)  =   "frmAddEditPigDoc4.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditPigDoc4.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPigDoc4.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPigDoc4.frx":3250
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPigDoc4.frx":356A
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPigDoc4.frx":3884
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditPigDoc4"
...
Dim IsOK As Boolean
   ...
   ElseIf ShowMode = SHOW_EDIT Then
      If Not VerifyAccessRight("PIG_IMPORT_EDIT") Then
         Call EnableForm(Me, True)
         Exit Function
      End If
   End If
   ...
   m_InventoryDoc.DOCUMENT_TYPE = 11
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      frmAddEditPigImport.COMMIT_FLAG = m_InventoryDoc.COMMIT_FLAG
      Set frmAddEditPigImport.TempCollection = m_InventoryDoc.ImportExports
      frmAddEditPigImport.ParentShowMode = ShowMode
      frmAddEditPigImport.ShowMode = SHOW_ADD
      frmAddEditPigImport.HeaderText = MapText("เพิ่มรายการนำเข้า")
      Load frmAddEditPigImport
      frmAddEditPigImport.Show 1

      OKClick = frmAddEditPigImport.OKClick

      Unload frmAddEditPigImport
      Set frmAddEditPigImport = Nothing
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      frmAddEditPigImport.ID = ID
      frmAddEditPigImport.COMMIT_FLAG = m_InventoryDoc.COMMIT_FLAG
      Set frmAddEditPigImport.TempCollection = m_InventoryDoc.ImportExports
      frmAddEditPigImport.HeaderText = MapText("แก้ไขรายการนำเข้า")
      frmAddEditPigImport.ParentShowMode = ShowMode
      frmAddEditPigImport.ShowMode = SHOW_EDIT
      Load frmAddEditPigImport
      frmAddEditPigImport.Show 1
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblDeliveryFee, MapText("ค่าสายพันธ์"))
   Call InitNormalLabel(lblDocumentDate, MapText("วันที่เอกสาร"))
   Call InitNormalLabel(lblMaterialPrice, MapText("ราคาสุกร"))
