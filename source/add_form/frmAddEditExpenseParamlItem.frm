...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblPartType, MapText("ประเภท ค.ช.จ."))
   Call InitNormalLabel(lblADG, MapText("ราคา/หน่วย"))
   Call InitNormalLabel(lblExpenseName, MapText("รายจ่าย"))
